...
async function setForwarding(driver, forwardRule, typeCall) {
    try {
        /*
        ...
        */
        ...
        switch (forwardRule) {
            ...
            case 'number':
                ...
                await driver.sleep(1000);
                await driver.findElement(By.xpath(`//fwd-type-control[@fwd='profile.${typeCall}._value']/div[@ng-if="fwd.ForwardType.selected=='TypeOfExtensionForward.ExternalNumber'"]/div/text-control/div[@ng-hide="prop.hide"]/input`)).sendKeys('79104061420');
                break;
        }
        return;
...
async function setQueueStatus(extension, forwardStatus, forwardRule) {
    try {
        ...
        await chooseForwardingStatus(driver, 'Away');
        await setForwarding(driver, forwardRule, 'InternalForwarding');
        await setForwarding(driver, forwardRule, 'ExternalForwarding');
...
module.exports.modifyForwardRules = setQueueStatus;